...
public class PerformanceTestUtils {
    ...
    public static DataFrame randomData(final int rows) {
        final DataFrame df = new DataFrame("name", "value", "category");
    ...
    public static DataFrame randomData(final double utilization) {
        final DataFrame df = new DataFrame("name", "value", "category");
